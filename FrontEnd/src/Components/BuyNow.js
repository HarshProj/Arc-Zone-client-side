        ...
        <div class="right">
          <div class="product-info">
            ...
            <ul className="buynow-ul-tags">
              <li><label><input type="radio" name="size" value="7" onChange={handleSizeChange} /><span className="bg">7</span></label></li>
              <li><label><input type="radio" name="size" value="8" onChange={handleSizeChange} /><span className="bg">8</span></label></li>
              <li><label><input type="radio" name="size" value="9" onChange={handleSizeChange} /><span className="bg">9</span></label></li>
              <li><label><input type="radio" name="size" value="10" onChange={handleSizeChange} /><span className="bg">10</span></label></li>
              <li><label><input type="radio" name="size" value="11" onChange={handleSizeChange} /><span className="bg">11</span></label></li>
              <li><label><input type="radio" name="size" value="11" onChange={handleSizeChange} /><span className="bg">12</span></label></li>
            </ul>
